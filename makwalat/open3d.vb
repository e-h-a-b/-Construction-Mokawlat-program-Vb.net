...
Public Class Form1
    ...
    Private Sub Form1_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize
        _3DCanvas01.Width = Me.Width
        _3DCanvas01.Height = Me.Height
    End Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        For i As Integer = 0 To 360
            ...
            Dim pn As New Pen(Brushes.Cyan, 2)

            Dim pn1 As New Pen(Brushes.DarkCyan, 1)
            Dim pn2 As New Pen(Brushes.Cyan, 1)



            '  DataGridView1.Rows.Add(x1 + ex, y1 + ey, 30, x2 + ex, y2 + ey, 30)
            If i >= 180 Then
                'curve with z height
                '  DataGridView1.Rows.Add(pt1.X + ex, pt1.Y + ey, 30 + i, pt2.X + ex, pt2.Y + ey, 30 + i)
                DataGridView1.Rows.Add(pt1.X + ex, pt1.Y + ey, 0, pt2.X + ex, pt2.Y + ey, 0)

                DataGridView1.Rows.Add(pt1.X + ex, 0, pt1.Y + ey, pt2.X + ex, 0, pt2.Y + ey)
                DataGridView1.Rows.Add(0, pt1.X + ex, pt1.Y + ey, 0, pt2.X + ex, pt2.Y + ey)
                'half circle
                'DataGridView1.Rows.Add(200, pt1.X + ex, pt1.Y + ey, 200, pt2.X + ex, pt2.Y + ey)
                'DataGridView1.Rows.Add(pt1.X + ex, 200, pt1.Y + ey, pt2.X + ex, 200, pt2.Y + ey)
                'DataGridView1.Rows.Add(pt1.X + ex, pt1.Y + ey, 0, pt2.X + ex, pt2.Y + ey, 0)


                ''point mark
                'DataGridView1.Rows.Add(pt1.X + 5, pt1.Y, 30 + i, pt1.X - 5, pt1.Y, 30 + i)
                'DataGridView1.Rows.Add(pt1.X, pt1.Y + 5, 30 + i, pt1.X, pt1.Y - 5, 30 + i)

                'limit circle
                '   DataGridView1.Rows.Add(pt1.X, pt1.Y, 30 + i, xc, yc, 30 + i)
                xc = pt1.X
                yc = pt1.Y
                ' DataGridView1.Rows.Add(pt1.X + ex, pt1.Y + ey, 30 + i, pt1.X + ex, pt1.Y + ey, 200)
            Else
                ' graph.DrawEllipse(pn2, xc + ex, yc + ey, 200, 200)
                ...
                'limit circle
                ' DataGridView1.Rows.Add(pt2.X, pt2.Y, 30 + i, xc, yc, 30 + i)
                xc = pt2.X
                yc = pt2.Y
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        Dim randoms(100) As String
        Dim randoms1(100) As String
        Dim randoms2(100) As String



        Dim ThePts As ArrayList

        Dim xn, yn As Integer
        For i As Integer = 0 To 100
            Dim chars = "0123456789"
            Dim random = New Random(Guid.NewGuid().GetHashCode())
            Dim randomString = New String(Enumerable.Repeat(chars, 3).[Select](Function(s) s(random.[Next](s.Length))).ToArray())
            Dim randomStringv = New String(Enumerable.Repeat(chars, 3).[Select](Function(s) s(random.[Next](s.Length))).ToArray())
            Dim randomStringz = New String(Enumerable.Repeat(chars, 3).[Select](Function(s) s(random.[Next](s.Length))).ToArray())

            randoms(i) = randomString
            randoms1(i) = randomStringv
            randoms2(i) = randomStringz
            ...
            Dim before
            Dim nn
            'DataGridView1.Rows.Add(i + 10, i + 10, i, 0, 0, 0)
            xn = randomString
            yn = randomStringv
            Button2.Text = randomString
            'DataGridView1.Rows.Add(randomString, randomStringv, randomStringz, randomString, randomStringv + 15, randomStringz - 15)

            'DataGridView1.Rows.Add(randomString, randomStringv, randomStringz, randomString, randomStringv - 15, randomStringz - 15)

            'DataGridView1.Rows.Add(randomString, randomStringv, randomStringz, randomString + 15, randomStringv, randomStringz - 15)
            'DataGridView1.Rows.Add(randomString, randomStringv, randomStringz, randomString - 15, randomStringv, randomStringz - 15)
            ''0
            'DataGridView1.Rows.Add(randomString, randomStringv - 15, randomStringz - 15, randomString, randomStringv + 15, randomStringz - 15)
            'DataGridView1.Rows.Add(randomString - 15, randomStringv, randomStringz - 15, randomString + 15, randomStringv, randomStringz - 15)
            ...
            DataGridView1.Rows.Add(mm * i, yy * i, xn, afterm - 200, beforem, after)
            DataGridView1.Rows.Add(mm * i + 200, yy * i, xn, afterm, beforem, after)

            DataGridView1.Rows.Add(afterm - 200, yy * i, after, mm * i + 200, beforem, after)
            afterm = mm * i + 200
            beforem = yy * i
            ...
            ' lines
            '  DataGridView1.Rows.Add(randomString, randomStringv, randomStringz, after, before, nn)
            after = randomString
            before = randomStringv
            nn = randomStringz
