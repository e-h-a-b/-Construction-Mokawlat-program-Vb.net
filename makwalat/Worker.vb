...
Public Class Worker
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        Dim result As String = wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=insertworker&macji=" + mac + "&namwr=" +
        TextBox1.Text + "&agewr=" + TextBox2.Text + "&adrswr=" + TextBox3.Text +
        "&citywr=" + TextBox4.Text + "&perjobwr=" + TextBox5.Text + "&permerwr=" + TextBox6.Text +
         "&pricwr=" + TextBox7.Text + "&fbwr=" + TextBox8.Text + "&linkwr=" + TextBox9.Text +
         "&statworkwr=" + TextBox10.Text)
    ...
    Sub fast()
        ...
        Dim result = wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=readworker")
        ritxt.Clear()
        ...
        Loop
        Dim col, col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11 As New DataGridViewTextBoxColumn
    ...
    Private Sub filesave_Click(sender As System.Object, e As System.EventArgs) Handles filesave.Click
        ...
        Else
            ...
            For x As Integer = 0 To DataGridView1.Rows.Count - 1
                ...
                text.AppendLine()
            Next
            IO.File.WriteAllText("C:\mokawalat\database\worker.busin", text.ToString())

        End If
    End Sub

    Private Sub fileopen_Click(sender As System.Object, e As System.EventArgs) Handles fileopen.Click
        GetCsvData("C:\mokawalat\database\worker.busin")
    ...
    Private Sub HtmlToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles HtmlToolStripMenuItem.Click
        html.saveashtml(DataGridView1, "C:\mokawalat\browser\Worker" & DateTime.Today.ToString("dd-MMM-yyyy") & ".html")
    End Sub
    ...
    Private Sub Panel2_Click(sender As Object, e As System.EventArgs) Handles Panel2.Click
        ...
        End If
    End Sub
    Private Sub worker_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize
        Panel2.Height = Me.Height
