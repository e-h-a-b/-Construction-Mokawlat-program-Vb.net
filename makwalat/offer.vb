...
Public Class offer
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim result As String = wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=insertoffer&namof=" + TextBox1.Text + "&placof=" + TextBox2.Text + "&offer=" + TextBox6.Text + "&prof=" + TextBox8.Text + "&fax=" + TextBox5.Text + "&link=" + TextBox7.Text + "&phonof=" + TextBox3.Text + "&mobof=" + TextBox4.Text + "&facb=" + TextBox9.Text)
    ...
    'Dim listuser2, listuser3, listuser4, listuser5, listuser6, listuser7, listuser8 As New RichTextBox
    ...
    '    Dim result = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer1")
    '    Dim result1 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer2")
    '    Dim result2 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer3")
    '    Dim result3 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer4")
    '    Dim result4 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer5")
    '    Dim result5 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer6")
    '    Dim result6 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer7")
    '    Dim result7 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer8")
    '    Dim result8 = Form1.wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offer9")
    ...
    '        l9 = ListBox8.GetItemText(ListBox8.SelectedItem)
    '        Dim row = {l1, l2, l8, l7, l5, l3, l4, l6, l9}
    ...
    Sub readdata()
        ...
        TextBox9.Text = autowrite.TextBox30.Text
        TextBox8.Text = autowrite.TextBox31.Text
        TextBox7.Text = autowrite.TextBox32.Text
        TextBox6.Text = autowrite.TextBox33.Text
        TextBox5.Text = autowrite.TextBox34.Text
        TextBox4.Text = autowrite.TextBox35.Text
        TextBox3.Text = autowrite.TextBox36.Text
        TextBox2.Text = autowrite.TextBox37.Text
        TextBox1.Text = autowrite.TextBox38.Text
    ...
    Sub fast()
        ...
        Dim result = wClient.DownloadString("http://ebank.esy.es/makwalat.php?action=offtotal")
        ritxt.Clear()
    ...
    'Private Sub Form7_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize
    ...
    'Label8.Location = New Point(Me.Width - (904 - 772), Label8.Location.Y)
    'Label9.Location = New Point(Me.Width - (904 - 772), Label9.Location.Y)
    ...
    'TextBox8.Location = New Point(Me.Width - (904 - 729), TextBox8.Location.Y)
    'TextBox9.Location = New Point(Me.Width - (904 - 729), TextBox9.Location.Y)
    ...
    Private Sub filesave_Click(sender As System.Object, e As System.EventArgs) Handles filesave.Click
        ...
        Else
            ...
            For x As Integer = 0 To DataGridView2.Rows.Count - 1
                ...
                text.AppendLine()
            Next
            IO.File.WriteAllText("C:\mokawalat\database\offercompany.busin", text.ToString())

        End If
    End Sub

    Private Sub fileopen_Click(sender As System.Object, e As System.EventArgs) Handles fileopen.Click
        GetCsvData("C:\mokawalat\database\offercompany.busin")
    ...
    Private Sub HtmlToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles HtmlToolStripMenuItem.Click
        html.saveashtml(DataGridView2, "C:\mokawalat\browser\Offer" & DateTime.Today.ToString("dd-MMM-yyyy") & ".html")
    End Sub
